...
class NewestVideosScreen extends StatefulWidget {
  static const String id = 'newest_videos';
  @override
  _NewestVideosScreenState createState() => _NewestVideosScreenState();
}

class _NewestVideosScreenState extends State<NewestVideosScreen> {
  @override
